 ...
 * curseur doré positionné au score actuel (le badge de la charte réduit à son
 * disque : à 15 px, sa dentelure et son glyphe seraient illisibles).
            ...
            <Svg width={barWidth} height={BAR_HEIGHT}>
              <Defs>
                <SvgLinearGradient id="prediscoreGradient" x1="0" y1="0" x2="1" y2="0">
                  <Stop offset="0" stopColor={colors.accentTransition} />
