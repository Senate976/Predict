...
/** Liste des sections de Paramètres — chacune ouvre pour l'instant un stub
 * générique (`SettingsStub`) ; « Informations légales » ouvre sa propre
 * sous-liste (Mentions légales, CGU, Confidentialité). */
