...
const styles = StyleSheet.create({
  ...
  flex: { flex: 1 },
  // Trait sous le choix, comme les onglets — plus de pilule colorée.
  visibilityRow: { flexDirection: 'row', marginTop: 10, borderBottomWidth: 1, borderBottomColor: colors.border },
  visibilityOption: {
    flex: 1,
    paddingVertical: 8,
    alignItems: 'center',
